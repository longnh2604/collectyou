...
class OldDrawingVC: UIViewController {
    
    //Variable
    lazy var isEdited: Bool = false
    lazy var onTemp: Bool = false
    lazy var isPanelExpanded: Bool = false
    ...
    lazy var stickersVCIsVisible = false
    ...
    var picRes = 1
    var carteIDTemp: Int?
    lazy var onSave: Bool = false
    lazy var onComparison : Bool = false
    var photoData: UIImage?
    var picCurrIndex: Int?
    lazy var stampIndex = 1
    
    weak var drawingPanelView: OldDrawingPanelView!
    ...
    fileprivate func updatePanelDrawingView() {
        drawingPanelView = OldDrawingPanelView.instanceFromNib(self)
        ...
        if isPanelExpanded == false {
            UIView.animate(withDuration: 0.3,
                           ...
                           animations: { () -> Void in
                            ...
                            self.btnSlideUp.setImage(UIImage(named: "icon_down.png"), for: .normal)
            ...
            UIView.animate(withDuration: 0.3,
                           ...
                           animations: { () -> Void in
                            ...
                            self.btnSlideUp.setImage(UIImage(named: "icon_up.png"), for: .normal)
                            self.view.layoutIfNeeded()
            }, completion: { (finished) -> Void in
...
extension OldDrawingVC: UIScrollViewDelegate {
...
extension OldDrawingVC: SketchViewDelegate {
...
extension OldDrawingVC: OldDrawingPanelViewDelegate {
...
extension OldDrawingVC: StickerPopupVCDelegate, UIGestureRecognizerDelegate {
...
extension OldDrawingVC: ShapePopupVCDelegate {
...
extension OldDrawingVC: EFColorSelectionViewControllerDelegate {
...
extension OldDrawingVC: UITextViewDelegate {
...
extension OldDrawingVC: TextInputPopupVCDelegate {
