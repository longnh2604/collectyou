...
public extension UIAccessibilityTraits {
    static func |= (left: inout UIAccessibilityTraits, right: inout UIAccessibilityTraits) {
        left = left | right
    }
    
    static func | (left: UIAccessibilityTraits, right: UIAccessibilityTraits) -> UIAccessibilityTraits {
        return UIAccessibilityTraits(rawValue: left.rawValue | right.rawValue)
    }
    
    static prefix func ~ (trait: UIAccessibilityTraits) -> UIAccessibilityTraits {
