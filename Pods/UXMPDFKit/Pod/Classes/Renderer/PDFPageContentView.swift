...
open class PDFPageContentView: UIScrollView, UIScrollViewDelegate {
    ...
    init(frame: CGRect, document: PDFDocument, page: Int) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(PDFPageContentView.keyboardWillShowNotification(_:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(PDFPageContentView.keyboardWillHideNotification(_:)), name: UIResponder.keyboardWillHideNotification, object: nil)
    ...
    override open func layoutSubviews() {
        ...
        containerView.frame = CGRect(x: viewFrame.origin.x, y: viewFrame.origin.y - 10, width: viewFrame.size.width, height: viewFrame.size.height)
