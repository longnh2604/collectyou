...
open class PDFViewController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        pageScrubber = PDFPageScrubber(frame: CGRect(x: 0, y: view.frame.size.height - bottomLayoutGuide.length, width: view.frame.size.width, height: 40), document: document)
    ...
    fileprivate func setupUI() {
        ...
        pageScrubber.heightAnchor.constraint(equalToConstant: 40.0).isActive = true
    ...
    fileprivate func reloadBarButtons() {
        ...
        if isPresentingInModal {
            navigationItem.leftBarButtonItem = UIBarButtonItem(title: "OK",
                                                               style: .plain,
                                                               target: self,
